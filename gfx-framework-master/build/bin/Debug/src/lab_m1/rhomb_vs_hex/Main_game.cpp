...
void Main_r_h::Update(float deltaTimeSeconds)
{
    if (totalLife == 0)
        return;
...
void Main_r_h::EnemyHit(std::vector<Star> &starsLine, std::vector <Romb> &rombsLine, int line ,Enemy &enemy )
{
...
//
void Main_r_h::ShootStar(int i,std::vector<Star> &line)
{
    Star star;
...
void Main_r_h::RombTypeRand(Romb &romb)
{
        switch (romb.GetType())
        {
        case 1:
...
void Main_r_h::SquareRand(float x,float y,std::string sq)
{
...
void Main_r_h::StarRand(float x, float y,float scx, float scy, float rotate, std::string star)
{
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(x, y);
...
void Main_r_h::RombRand(float x, float y, float scx, float scy, std::string romb)
{
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(x, y);
    modelMatrix *= transform2D::Scale(scx, scy);
...
void Main_r_h::EnemyRand(float x, float y, float scx, float scy, int type)
{
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(x, y);
    modelMatrix *= transform2D::Scale(scx, scy);
...
void Main_r_h::OnInputUpdate(float deltaTime, int mods)
{
}


void Main_r_h::OnKeyPress(int key, int mods)
{
    // Add key press event
}


void Main_r_h::OnKeyRelease(int key, int mods)
{
    // Add key release event
}


void Main_r_h::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
    glm::ivec2 resolution = window->GetResolution();
...
void Main_r_h::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
    glm::ivec2 resolution = window->GetResolution();
...
void Main_r_h::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
    glm::ivec2 resolution = window->GetResolution();
...
bool Main_r_h::DecreaseTotalPoints(int type)
{
    switch (type)
    {
    case 1:
...
void Main_r_h::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}


void Main_r_h::OnWindowResize(int width, int height)
{
}
